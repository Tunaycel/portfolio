...
- Experience, skills, education and Oracle certification, plus a dedicated Azure thesis chapter at `/research/azure-incident-response`. Five documented trials can be inspected by stage through an accessible interactive chart and data table. Research is explicitly in progress.
