...
export const metadata: Metadata = {
  ...
  openGraph: {title:"Hüseyin Tunay Çelik — Software Engineer",description:"Thoughtful code. Real-world impact. AI integration, full-stack products and cloud systems.",type:"website",locale:"en_GB"},
