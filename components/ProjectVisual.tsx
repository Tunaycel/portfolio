    ...
    <div className={`project-visual visual-${slug}`} aria-hidden="true">
      ...
      {slug === "local-llm-pipeline" ? (
        ...
        <div className="commerce-art">
          <span className="market market-one">t.</span>
          <div className="commerce-hub">
            p<span>ORDER / STOCK / SYNC</span>
          </div>
          <span className="market market-two">hb</span>
        ...
        <div className="property-art">
          <div className="property-frame">
            ...
            <span>
              A place to call <em>home.</em>
            </span>
            <small>PHOTO + TEMPLATE + TYPOGRAPHY</small>
          </div>
          <div className="property-offset" />
        </div>
      ) : slug === "cvforge" ? (
        <div className="resume-art">
          ...
          <div className="cloud-stamp">
            S3<small>STORED SECURELY</small>
          </div>
        </div>
      ) : (
